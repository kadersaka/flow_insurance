...
class SpeechSampleApp extends StatefulWidget {
  final Function() fun;
  SpeechSampleApp({Key? key, required this.fun}) : super(key: key);
  @override
...
class SessionOptionsWidget extends StatelessWidget {
  const SessionOptionsWidget(this.currentLocaleId, this.switchLang, this.localeNames, this.logEvents, this.switchLogging, this.pauseForController, this.listenForController, {Key? key})
      : super(key: key);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //         )),
          //     Container(padding: EdgeInsets.only(left: 16), child: Text('listenFor: ')),
          //     Container(
          //         padding: EdgeInsets.only(left: 8),
          //         width: 80,
          //         child: TextFormField(
