...
class _AccueilDiagnosticState extends State<AccueilDiagnostic> {
  ...
  Future<void> _initInfo() async {
    ...
    Future.delayed(const Duration(milliseconds: 1500), (() {
      setState(() {});
      loading = false;
      for (int i = 0; i < StringData.essai.length; i++)
        showButton = showButton || (StringData.essai[i][2] != '');
    }));
  }
                ...
                children: [
                  ...
                  showButton
                      ? Container(
                          ...
                          child: CustomWidget()
                              .mybutton(size, StringData.continuer, () {
                            DataBaseService()
                                .setPhoneDetailsToDatabase()
